...
public class ClassInfoController extends BaseController {
	...
	public void list(String classNo,String className,String banzhuren,String beginDate,Integer page,Integer rows, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
		...
		List<ClassInfo> classInfoList = classInfoService.queryClassInfo(classNo, className, banzhuren, beginDate, page);
	    /*计算总的页数和总的记录数*/
	    classInfoService.queryTotalPageAndRecordNumber(classNo, className, banzhuren, beginDate);
	    /*获取到总的页码数目*/
	...
	public String frontlist(String classNo,String className,String banzhuren,String beginDate,Integer currentPage, Model model, HttpServletRequest request) throws Exception  {
		if (currentPage==null || currentPage == 0) currentPage = 1;
		if (classNo == null) classNo = "";
		if (className == null) className = "";
		if (banzhuren == null) banzhuren = "";
		if (beginDate == null) beginDate = "";
		List<ClassInfo> classInfoList = classInfoService.queryClassInfo(classNo, className, banzhuren, beginDate, currentPage);
	    /*计算总的页数和总的记录数*/
	    classInfoService.queryTotalPageAndRecordNumber(classNo, className, banzhuren, beginDate);
	    /*获取到总的页码数目*/
	    int totalPage = classInfoService.getTotalPage();
	    ...
	    request.setAttribute("banzhuren", banzhuren);
	...
	public void OutToExcel(String classNo,String className,String banzhuren,String beginDate, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
        if(classNo == null) classNo = "";
        if(className == null) className = "";
        if(banzhuren == null) banzhuren = "";
        if(beginDate == null) beginDate = "";
        List<ClassInfo> classInfoList = classInfoService.queryClassInfo(classNo,className,banzhuren,beginDate);
        ...
        for(int i=0;i<classInfoList.size();i++) {
        	...
        	dataset.add(new String[]{classInfo.getClassNo(),classInfo.getClassName(),classInfo.getBanzhuren(),classInfo.getBeginDate()});
        }
        /*
