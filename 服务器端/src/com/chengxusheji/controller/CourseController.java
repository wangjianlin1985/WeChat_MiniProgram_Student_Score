...
public class CourseController extends BaseController {
	...
	public void list(String courseNo,String courseName,String teacherName,String coursePlace,Integer page,Integer rows, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
		...
		List<Course> courseList = courseService.queryCourse(courseNo, courseName, teacherName, coursePlace, page);
	    /*计算总的页数和总的记录数*/
	    courseService.queryTotalPageAndRecordNumber(courseNo, courseName, teacherName, coursePlace);
	    /*获取到总的页码数目*/
	...
	public String frontlist(String courseNo,String courseName,String teacherName,String coursePlace,Integer currentPage, Model model, HttpServletRequest request) throws Exception  {
		if (currentPage==null || currentPage == 0) currentPage = 1;
		if (courseNo == null) courseNo = "";
		if (courseName == null) courseName = "";
		if (teacherName == null) teacherName = "";
		if (coursePlace == null) coursePlace = "";
		List<Course> courseList = courseService.queryCourse(courseNo, courseName, teacherName, coursePlace, currentPage);
	    /*计算总的页数和总的记录数*/
	    courseService.queryTotalPageAndRecordNumber(courseNo, courseName, teacherName, coursePlace);
	    /*获取到总的页码数目*/
	    int totalPage = courseService.getTotalPage();
	...
	public void OutToExcel(String courseNo,String courseName,String teacherName,String coursePlace, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
        if(courseNo == null) courseNo = "";
        if(courseName == null) courseName = "";
        if(teacherName == null) teacherName = "";
        if(coursePlace == null) coursePlace = "";
        List<Course> courseList = courseService.queryCourse(courseNo,courseName,teacherName,coursePlace);
        ExportExcelUtil ex = new ExportExcelUtil();
        String _title = "Course信息记录"; 
        String[] headers = { "课程编号","课程名称","课程照片","任课教师","总课时","课程学分","上课教室"};
        List<String[]> dataset = new ArrayList<String[]>(); 
        for(int i=0;i<courseList.size();i++) {
        	Course course = courseList.get(i); 
        	dataset.add(new String[]{course.getCourseNo(),course.getCourseName(),course.getCoursePhoto(),course.getTeacherName(),course.getCourseCount() + "",course.getCourseScore() + "",course.getCoursePlace()});
        }
        /*
