...
public class ClassInfoService {
    ...
    /*按照查询条件分页查询班级信息记录*/
    public ArrayList<ClassInfo> queryClassInfo(String classNo,String className,String banzhuren,String beginDate,int currentPage) throws Exception { 
    	...
    	if(!banzhuren.equals("")) where = where + " and t_classInfo.banzhuren like '%" + banzhuren + "%'";
    	if(!beginDate.equals("")) where = where + " and t_classInfo.beginDate like '%" + beginDate + "%'";
    	int startIndex = (currentPage-1) * this.rows;
    	return classInfoMapper.queryClassInfo(where, startIndex, this.rows);
    }

    /*按照查询条件查询所有记录*/
    public ArrayList<ClassInfo> queryClassInfo(String classNo,String className,String banzhuren,String beginDate) throws Exception  { 
     	String where = "where 1=1";
    	if(!classNo.equals("")) where = where + " and t_classInfo.classNo like '%" + classNo + "%'";
    	if(!className.equals("")) where = where + " and t_classInfo.className like '%" + className + "%'";
    	if(!banzhuren.equals("")) where = where + " and t_classInfo.banzhuren like '%" + banzhuren + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String classNo,String className,String banzhuren,String beginDate) throws Exception {
     	String where = "where 1=1";
    	if(!classNo.equals("")) where = where + " and t_classInfo.classNo like '%" + classNo + "%'";
    	if(!className.equals("")) where = where + " and t_classInfo.className like '%" + className + "%'";
    	if(!banzhuren.equals("")) where = where + " and t_classInfo.banzhuren like '%" + banzhuren + "%'";
