...
public class StudentService {
    ...
    /*按照查询条件分页查询学生信息记录*/
    public ArrayList<Student> queryStudent(String studentNumber,ClassInfo classInfoId,String studentName,String birthday,String telephone,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(!studentNumber.equals("")) where = where + " and t_student.studentNumber like '%" + studentNumber + "%'";
    	if(null != classInfoId &&  classInfoId.getClassNo() != null  && !classInfoId.getClassNo().equals(""))  where += " and t_student.classInfoId='" + classInfoId.getClassNo() + "'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Student> queryStudent(String studentNumber,ClassInfo classInfoId,String studentName,String birthday,String telephone) throws Exception  { 
     	String where = "where 1=1";
    	if(!studentNumber.equals("")) where = where + " and t_student.studentNumber like '%" + studentNumber + "%'";
    	if(null != classInfoId &&  classInfoId.getClassNo() != null && !classInfoId.getClassNo().equals(""))  where += " and t_student.classInfoId='" + classInfoId.getClassNo() + "'";
    	if(!studentName.equals("")) where = where + " and t_student.studentName like '%" + studentName + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String studentNumber,ClassInfo classInfoId,String studentName,String birthday,String telephone) throws Exception {
     	String where = "where 1=1";
    	if(!studentNumber.equals("")) where = where + " and t_student.studentNumber like '%" + studentNumber + "%'";
    	if(null != classInfoId &&  classInfoId.getClassNo() != null && !classInfoId.getClassNo().equals(""))  where += " and t_student.classInfoId='" + classInfoId.getClassNo() + "'";
    	if(!studentName.equals("")) where = where + " and t_student.studentName like '%" + studentName + "%'";
