...
public class CourseService {
    ...
    /*按照查询条件分页查询课程信息记录*/
    public ArrayList<Course> queryCourse(String courseNo,String courseName,String teacherName,String coursePlace,int currentPage) throws Exception { 
    	...
    	if(!teacherName.equals("")) where = where + " and t_course.teacherName like '%" + teacherName + "%'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Course> queryCourse(String courseNo,String courseName,String teacherName,String coursePlace) throws Exception  { 
     	String where = "where 1=1";
    	if(!courseNo.equals("")) where = where + " and t_course.courseNo like '%" + courseNo + "%'";
    	if(!courseName.equals("")) where = where + " and t_course.courseName like '%" + courseName + "%'";
    	if(!teacherName.equals("")) where = where + " and t_course.teacherName like '%" + teacherName + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String courseNo,String courseName,String teacherName,String coursePlace) throws Exception {
     	String where = "where 1=1";
    	if(!courseNo.equals("")) where = where + " and t_course.courseNo like '%" + courseNo + "%'";
    	if(!courseName.equals("")) where = where + " and t_course.courseName like '%" + courseName + "%'";
    	if(!teacherName.equals("")) where = where + " and t_course.teacherName like '%" + teacherName + "%'";
