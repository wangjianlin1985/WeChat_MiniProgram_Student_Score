...
public class ScoreInfoService {
    ...
    /*按照查询条件分页查询成绩信息记录*/
    public ArrayList<ScoreInfo> queryScoreInfo(Student studentNumber,Course courseNo,int currentPage) throws Exception { 
    	...
    	if(null != courseNo &&  courseNo.getCourseNo() != null  && !courseNo.getCourseNo().equals(""))  where += " and t_scoreInfo.courseNo='" + courseNo.getCourseNo() + "'";
    ...
    /*查询成绩排行榜*/
    public ArrayList<ScoreInfo> queryTopScoreInfo() throws Exception { 
     	String where = "where 1=1";
    	 
    	return scoreInfoMapper.queryTopScoreInfo();
    }
    

    /*按照查询条件查询所有记录*/
    public ArrayList<ScoreInfo> queryScoreInfo(Student studentNumber,Course courseNo) throws Exception  { 
     	String where = "where 1=1";
    	if(null != studentNumber &&  studentNumber.getStudentNumber() != null && !studentNumber.getStudentNumber().equals(""))  where += " and t_scoreInfo.studentNumber='" + studentNumber.getStudentNumber() + "'";
    	if(null != courseNo &&  courseNo.getCourseNo() != null && !courseNo.getCourseNo().equals(""))  where += " and t_scoreInfo.courseNo='" + courseNo.getCourseNo() + "'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(Student studentNumber,Course courseNo) throws Exception {
     	String where = "where 1=1";
    	if(null != studentNumber &&  studentNumber.getStudentNumber() != null && !studentNumber.getStudentNumber().equals(""))  where += " and t_scoreInfo.studentNumber='" + studentNumber.getStudentNumber() + "'";
    	if(null != courseNo &&  courseNo.getCourseNo() != null && !courseNo.getCourseNo().equals(""))  where += " and t_scoreInfo.courseNo='" + courseNo.getCourseNo() + "'";
