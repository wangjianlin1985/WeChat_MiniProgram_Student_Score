...
<%
    ...
    Course courseNo = (Course)request.getAttribute("courseNo");
%>
<!DOCTYPE html>
<html>
<head>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>成绩编号</td><td>考察学生</td><td>考察课程</td><td>成绩得分</td><td>学生评价</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td><%=scoreInfo.getCourseNo().getCourseName() %></td>
 											<td><%=scoreInfo.getScore() %></td>
 											<td><%=scoreInfo.getEvaluate() %></td>
 											<td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="scoreInfoQueryForm" id="scoreInfoQueryForm" action="<%=basePath %>ScoreInfo/frontlist" class="mar_t15" method="post">
            <div class="form-group">
            	<label for="studentNumber_studentNumber">考察学生：</label>
            ...
            <div class="form-group">
            	<label for="courseNo_courseNo">考察课程：</label>
                <select id="courseNo_courseNo" name="courseNo.courseNo" class="form-control">
                	<option value="">不限制</option>
	 				<%
	 				for(Course courseTemp:courseList) {
	 					String selected = "";
 					if(courseNo!=null && courseNo.getCourseNo()!=null && courseNo.getCourseNo().equals(courseTemp.getCourseNo()))
 						selected = "selected";
	 				%>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="scoreInfo_studentNumber_studentNumber_edit" class="col-md-3 text-right">考察学生:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="scoreInfo_courseNo_courseNo_edit" class="col-md-3 text-right">考察课程:</label>
		  	 <div class="col-md-9">
			    <select id="scoreInfo_courseNo_courseNo_edit" name="scoreInfo.courseNo.courseNo" class="form-control">
			    </select>
		  	 </div>
		  </div>
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			    <input type="text" id="scoreInfo_score_edit" name="scoreInfo.score" class="form-control" placeholder="请输入成绩得分">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="scoreInfo_evaluate_edit" class="col-md-3 text-right">学生评价:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="scoreInfo_evaluate_edit" name="scoreInfo.evaluate" class="form-control" placeholder="请输入学生评价">
			 </div>
		  </div>
		</form> 
			...
			if (scoreInfo) {
				...
				$.ajax({
					...
					success: function(courses,response,status) { 
		        		...
		        		$("#scoreInfo_courseNo_courseNo_edit").val(scoreInfo.courseNoPri);
					}
				});
				$("#scoreInfo_score_edit").val(scoreInfo.score);
				$("#scoreInfo_evaluate_edit").val(scoreInfo.evaluate);
