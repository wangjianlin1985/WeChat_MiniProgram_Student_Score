...
<%
    ...
    ClassInfo classInfoId = (ClassInfo)request.getAttribute("classInfoId");
	...
	<div class="col-md-9 wow fadeInLeft">
		...
		<div class="row">
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Student/<%=student.getStudentNumber() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=student.getPhotoUrl()%>" /></a>
			     <div class="showFields">
			     	<div class="field">
	            		学号:<%=student.getStudentNumber() %>
			     	</div>
			     	<div class="field">
	            		所在班级:<%=student.getClassInfoId().getClassName() %>
			     	</div>
			     	<div class="field">
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="studentQueryForm" id="studentQueryForm" action="<%=basePath %>Student/frontlist" class="mar_t15" method="post">
            ...
            <div class="form-group">
                ...
                <select id="classInfoId_classNo" name="classInfoId.classNo" class="form-control">
                	<option value="">不限制</option>
	 				<%
	 				for(ClassInfo classInfoTemp:classInfoList) {
	 					String selected = "";
 					if(classInfoId!=null && classInfoId.getClassNo()!=null && classInfoId.getClassNo().equals(classInfoTemp.getClassNo()))
 						selected = "selected";
	 				%>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="student_password_edit" class="col-md-3 text-right">学生密码:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="student_password_edit" name="student.password" class="form-control" placeholder="请输入学生密码">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="student_classInfoId_classNo_edit" class="col-md-3 text-right">所在班级:</label>
		  	 <div class="col-md-9">
			    <select id="student_classInfoId_classNo_edit" name="student.classInfoId.classNo" class="form-control">
			    </select>
		  	 </div>
		  </div>
		  <div class="form-group">
