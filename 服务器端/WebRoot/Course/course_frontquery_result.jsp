...
<%
    ...
    String teacherName = (String)request.getAttribute("teacherName"); //任课教师查询关键字
...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Course/frontlist">课程信息信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>Course/course_frontAdd.jsp" style="display:none;">添加课程信息</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Course/<%=course.getCourseNo() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=course.getCoursePhoto()%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		任课教师:<%=course.getTeacherName() %>
			     	</div>
			     	<div class="field">
	            		总课时:<%=course.getCourseCount() %>
			     	</div>
			     	<div class="field">
	            		课程学分:<%=course.getCourseScore() %>
			     	</div>
			     	<div class="field">
	            		上课教室:<%=course.getCoursePlace() %>
			     	</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="course_courseMemo_edit" class="col-md-3 text-right">课程简介:</label>
		  	 <div class="col-md-9">
			    <textarea id="course_courseMemo_edit" name="course.courseMemo" rows="8" class="form-control" placeholder="请输入课程简介"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
