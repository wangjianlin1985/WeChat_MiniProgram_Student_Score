	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="classInfoQueryForm" id="classInfoQueryForm" action="<%=basePath %>ClassInfo/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				...
				<input type="text" id="banzhuren" name="banzhuren" value="<%=banzhuren %>" class="form-control" placeholder="请输入班主任姓名">
			</div>
			...
			<div class="form-group">
				...
				<input type="text" id="beginDate" name="beginDate" class="form-control"  placeholder="请选择成立日期" value="<%=beginDate %>" onclick="SelectDate(this,'yyyy-MM-dd')" />
			</div>
